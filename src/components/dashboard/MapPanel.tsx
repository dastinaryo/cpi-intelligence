...
const MapPanel = () => {
  ...
  return (
    <div className="relative h-full min-h-[360px] w-full overflow-hidden rounded-xl border border-border bg-card shadow-sm">
      ...
      {chatOpen && (
        <div className="pointer-events-auto absolute right-4 bottom-4 z-30 flex h-[420px] w-[340px] max-w-[calc(100%-2rem)] flex-col overflow-hidden rounded-xl border border-border bg-card/95 shadow-xl backdrop-blur">
